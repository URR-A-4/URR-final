    ...
    >
      <SwiperSlide>
        <div className="xl:w-full xl:h-[900px] relative">
          <Image src={banner1} alt="mainImg" fill sizes="(min-width: 768px) 100vw" priority className="object-contain" />
        </div>
      ...
      <SwiperSlide>
        <div className="xl:w-full relative">
          <Link href={"/products/detail/a291eb38-cdd7-4a97-87d0-314cec358b1f"}>
            <div className="xl:w-full xl:h-[900px] relative">
              <Image src={banner2} alt="mainImg" fill sizes="(min-width: 768px) 100vw" priority className="object-contain" />
            </div>
          </Link>
        </div>
      ...
      <SwiperSlide>
        <div className="xl:w-full xl:h-[900px] relative">
          <Image src={banner3} alt="mainImg" fill sizes="(min-width: 768px) 100vw" priority className="object-contain" />
        </div>
        <div className="w-full h-[328px] relative xl:hidden">
      ...
      <SwiperSlide>
        <div className="xl:w-full xl:h-[900px] relative">
          <Image src={banner4} alt="mainImg" fill sizes="(min-width: 768px) 100vw" priority className="object-contain" />
        </div>
        <div className="w-full h-[328px] relative xl:hidden">
      ...
      <SwiperSlide>
        <div className="xl:w-full relative">
          <Link href={"/influencer"}>
            <div className="xl:w-full xl:h-[900px] relative">
              <Image src={banner5} alt="mainImg" fill sizes="(min-width: 768px) 100vw" priority className="object-contain" />
            </div>
          </Link>
        </div>
